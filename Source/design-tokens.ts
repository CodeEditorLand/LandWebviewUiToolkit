...
export const background = create<string>(
	"background",
...
export const cornerRadiusRound = create<number>(
	"corner-radius-round"
).withDefault(2);
...
export const scrollbarWidth =
	create<string>("scrollbarWidth").withDefault("10px");
export const scrollbarHeight =
	create<string>("scrollbarHeight").withDefault("10px");
export const scrollbarSliderBackground = create<string>(
	"scrollbar-slider-background",
	"--vscode-scrollbarSlider-background"
).withDefault("#79797966");
export const scrollbarSliderHoverBackground = create<string>(
	"scrollbar-slider-hover-background",
	"--vscode-scrollbarSlider-hoverBackground"
).withDefault("#646464b3");
export const scrollbarSliderActiveBackground = create<string>(
